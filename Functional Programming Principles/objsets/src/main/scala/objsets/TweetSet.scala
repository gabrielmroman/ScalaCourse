...
class Empty extends TweetSet {
  ...
  // an empty tweet united with another tweet will result in the other tweet
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    val greaterThanElem = this.filter((x: Tweet) => x.retweets > elem.retweets)
      if(greaterThanElem.isEmpty) elem
      else greaterThanElem mostRetweeted
  }
  /**
    * The following methods are already implemented
    */
